  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-300">
      ...
      <div className="rounded-3xl border border-[#E2E8E4] bg-white p-6 sm:p-8 shadow-xs space-y-3">
        ...
        <p className="text-xs sm:text-sm text-[#5B6B63] leading-relaxed">{t('privacy.subtitle')}</p>
        <div className="pt-2">
          <Link
            to="/privacy"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#E7F2EC] hover:bg-[#d8ebe0] text-xs font-bold text-[#1B5E3A] border border-[#1B5E3A]/20 transition-all shadow-2xs"
          >
            <span>{t('about.privacy_link')}</span>
